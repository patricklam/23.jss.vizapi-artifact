...
It is common for software developers to use visualizations for development aspects but there are no common standard tools besides building your own and using existing toolkits~\cite{paredes2014}. There is a plethora of information visualization tools and toolkits~\cite{heer2010,liu2014} that enable developers to create visualizations from different kinds of data types. 
