...
VizAPI includes two phases: (1) data extraction and (2)
visualization. 
...
techniques~\cite{christensen03:_precis_analy_strin_expres}. Our machinery does not provide enough information to
