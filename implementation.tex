...
To do this, VizAPI needs to collect information about interactions between clients, libraries and dependencies. We provide a few examples of interactions---enough to give the idea of what VizAPI is looking for, but not an exhaustive list.
