...
dynamic call graphs as well as other client-library interactions such as field accesses
and annotation usage. 

The visualization phase transforms the extracted data into d3 format using our customized version
of the d3graph\footnote{\url{https://pypi.org/project/d3graph/}} library in Python, generates d3js\footnote{\url{https://d3js.org/}}
visualizations and makes it
available to users. 
