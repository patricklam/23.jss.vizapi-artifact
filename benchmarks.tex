...
We have made our existing code pipeline (VizAPI, analysis tool), and data publicly available, and invite readers to run VizAPI both on the demonstration configuration that we provide, as well as on inputs of interest. Discussion of the results is beyond the scope of this paper.
