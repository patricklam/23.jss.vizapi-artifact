...
We have made our existing code pipeline and data publicly available\footnote{\url{https://zenodo.org/record/6951140}}, and invite readers to run VizAPI both on the demonstration configuration that we provide, as well as on inputs of interest. Discussion of the results is beyond the scope of this paper.
