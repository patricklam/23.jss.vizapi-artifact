...
In this paper, we describe the design and implementation of VizAPI, including our approach to static and dynamic analysis using the Javassist library. We focus on artifact-level issues: to help future developers of program analysis tools, we discuss viable alternative libraries that we could have used to implement this tool and discuss when different libraries are applicable. We then explain how we collected a dataset for VizAPI consisting of 11 libraries and 90 clients, transitively including 4297 components in all. Finally, we discuss potential future uses of VizAPI.
\end{abstract}
